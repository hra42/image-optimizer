...
// PDFs, which go through ProcessBundle). This mirrors how the upload handler
// partitions bundles away, and keeps these vips tests from asserting on presets
// the vips pipeline never produces.
